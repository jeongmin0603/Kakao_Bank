...
public class Start extends Frame {
	...
	private JPanel getSouth() {
		...
		panel.add(Layout.coverFlowlayout(new Button(350, 50, "로그인", new ClickLogin())));
		panel.add(Layout.coverFlowlayout(new Button(350, 50, "회원가입", new ClickRegister())));
	...
	private JPanel getIcon() {
		...
		panel.add(new JLabel(Style.getImageIcon(150, 150, "\\icon\\kakao.png")));
