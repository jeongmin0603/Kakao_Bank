...
public class RemittanceInfo extends JPanel {
	...
	private TextField number = new TextField(150, 30);
	...
	public static void main(String[] args) {
		...
		jf.add(Layout.coverFlowlayout(new RemittanceInfo(new Account())));
	...
	public RemittanceInfo(Account account) {
		...
		add(Layout.coverFlowlayout(Layout.coverVertical(Layout.coverFlowlayout(error),
				Layout.coverFlowlayout(new TextButton(300, 40, "다음", new ClickNextButton(), amount, number)))),
				BorderLayout.SOUTH);
	}
